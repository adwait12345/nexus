...
<div class="top">
<div class="profile">
<img style="position: relative;left: -35px;width: 40px;height: 40px; border-radius: 100% ; object-fit: cover;"src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTl94iP-Rpd_rAEjysMj-1q_f9eQfvbY9l_YQ&usqp=CAU" alt="">
</div>

<p style="position: relative;left: -145px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size: 16px;"> Gojo Saturo <a style="text-decoration: none;font-size: 13px;" href="#">&#8226; Follow</a></p>
...
<img style="width: 100%;
object-fit: cover;
height: 100%;" id="photo" src="https://picsum.photos/700" alt="">
</div>
<div class="buttons">
<div class="left">
<div class="like" 
...
document.querySelector("#photo").setAttribute("src","https://picsum.photos/700")

// Add new item to list
document.querySelector('.scroll').appendChild(section);




// Stop form from Submittng
return false;
    }
